...
//  DataStructures
//
//  Created by James Landess on 5/10/17.
//  Copyright (c) 2017 James Landess. All rights reserved.
//

#ifndef DataStructures_Delegate_h
#define DataStructures_Delegate_h
#include <cassert>
...
namespace PDP
{
    ...
    public:
        ...
        {
            *this = Bind(object_ptr, method_ptr);
        }
        ...
        {
            return *this = Bind(static_cast<C*>(object_ptr_), rhs);
        }
        
        template <class C>
        Delegate& operator=(R (C::* const rhs)(A...) const)
        {
            return *this = Bind(static_cast<C const*>(object_ptr_), rhs);
        }
        ...
        static Delegate Bind(C* const object_ptr) noexcept
        {
            return { object_ptr, method_stub<C, method_ptr> };
        }
        
        template <class C, R (C::* const method_ptr)(A...) const>
        static Delegate Bind(C const* const object_ptr) noexcept
        {
        ...
        template <class C, R (C::* const method_ptr)(A...) const>
        static Delegate Bind(C const& object) noexcept
        {
        ...
        static Delegate Bind(R (* const function_ptr)(A...))
        {
            return function_ptr;
        }
        ...
        template <class C>
        static Delegate Bind(C* const object_ptr,
        ...
        template <class C>
        static Delegate Bind(C const* const object_ptr,
        ...
        template <class C>
        static Delegate Bind(C& object, R (C::* const method_ptr)(A...))
        {
            return member_pair<C>(&object, method_ptr);
        }
        
        template <class C>
        static Delegate Bind(C const& object,
                             R (C::* const method_ptr)(A...) const)
        {
