...
namespace gems
{
    ...
    public:
        ...
        //typedef std::is_bidirectional_iterator<iterator,
        //value_type, reference, pointer, difference_type>
        //reverse_iterator;
        //typedef std::is_bidirectional_iterator<const_iterator,
        // value_type, const_reference, const_pointer, difference_type>
        //const_reverse_iterator;

        // typedef std::is_bidirectional_iterator<child_iterator,
        // value_type, reference, pointer, difference_type>
        //reverse_child_iterator;
        // typedef std::is_bidirectional_iterator<const_child_iterator,
        //value_type, const_reference, const_pointer, difference_type>
    ...
    private:
        ...
        static TreeT* create_subtree(const TreeT& copy)
        {
            ...
            std::auto_ptr<TreeT> a((TreeT*)_alloc.allocate(1));
            TreeT* t = a.get();
