...
namespace LD
{
    ...
    template<typename T, typename... Ts> struct index<T, T, Ts...>: LD::Detail::IntegralConstant<int, 0> {};
    template<typename T, typename U, typename... Ts> struct index<T, U, Ts...>: LD::Detail::IntegralConstant<int, index<T, Ts...>::value + 1> {};
    ...
    {
        using ValueTypeList = extract<2, 1, Ts...>;
