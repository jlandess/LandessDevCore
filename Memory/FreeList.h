...
namespace PDP
{
    namespace Memory
    {
        ...
        class GrowthPolicy >
        inline FreeList< T, AllocationPolicy, GrowthPolicy >::FreeList()
        {
        ...
        class AllocationPolicy,
        class GrowthPolicy >
        inline FreeList< T, AllocationPolicy, GrowthPolicy >::FreeList( const GrowthPolicy& gp )
        : GrowthPolicy( gp )
        {
            unsigned int numElementsToPrealloc = GrowthPolicy::GetNumberToPreallocate();
            if( numElementsToPrealloc > 0 )
        ...
        class AllocationPolicy,
        class GrowthPolicy >
        inline T* FreeList< T, AllocationPolicy, GrowthPolicy >::Allocate()
        {
        ...
        class AllocationPolicy,
        class GrowthPolicy >
        inline void FreeList< T, AllocationPolicy, GrowthPolicy >::Free( T* pObject )
        {
            if( !pObject )
                return;
        ...
        inline T* FreeList< T, AllocationPolicy, GrowthPolicy >::Allocate( A1 a1 )
        {
            void* pItem = RetrieveFreeItem();
            if( !pItem )
                return 0;
        ...
        inline T* FreeList< T, AllocationPolicy, GrowthPolicy >::Allocate( A1 a1, A2 a2 )
        {
            void* pItem = RetrieveFreeItem();
            if( !pItem )
                return 0;
        ...
        inline T* FreeList< T, AllocationPolicy, GrowthPolicy >::Allocate( A1 a1, A2 a2, A3 a3 )
        {
            void* pItem = RetrieveFreeItem();
            if( !pItem )
                return 0;
        ...
        inline T* FreeList< T, AllocationPolicy, GrowthPolicy >::Allocate( A1 a1, A2 a2, A3 a3, A4 a4 )
        {
            void* pItem = RetrieveFreeItem();
            if( !pItem )
                return 0;
        ...
        class AllocationPolicy,
        class GrowthPolicy >
        inline void* FreeList< T, AllocationPolicy, GrowthPolicy >::RetrieveFreeItem()
        {
