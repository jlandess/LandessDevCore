...
#include <string>
#include <vector>
#include <Primitives/Functor/LightWeightDelegate.h>
#include <Primitives/Functor/FastDelegate.h>
...
/// This acts like a coroutine, but is implemented as a separate thread.
        ...
        private:
            ...
            PDP::UniquePointer<InnerControl> _inner;
	
            PDP::UniquePointer<Thread>       _thread;
...
/// ----------------------------------------------------------------------------
        ...
        public:
            ...
            void WaitForExpectedValue(const PDP::LightWeightDelegate<T(Args...)> & delegate, const T & expectedValue, Args && ...arguements)
    
            {
        
                while (delegate(PDP::Forward<Args>(arguements)...) != expectedValue)
            ...
            void WaitForExpectedValue(const PDP::FastDelegate<T(Args...)> & delegate, const T & expectedValue, Args && ...arguements)
