...
#include <Primitives/Threads/Atomic/AtomicOps.h>
#include <type_traits>
#include <utility>
#include <cassert>
#include <stdexcept>
    ...
    namespace MultiThreading
    {
        ...
        public:
...
#endif
            {
                ...
                fence(Asynchronous::memory_order_sync);
            }
            ...
            bool try_dequeue(U& result)
            {
                ...
                fence(Asynchronous::memory_order_acquire);
                ...
                if (blockFront != blockTail) {
                    ...
                    fence(Asynchronous::memory_order_release);
                    ...
                    fence(Asynchronous::memory_order_release);		// Expose possibly pending changes to frontBlock->front from last dequeue
                    frontBlock = frontBlock_ = nextBlock;
                    
                    compiler_fence(Asynchronous::memory_order_release);	// Not strictly needed
            ...
            bool pop()
            {
                ...
                if (blockFront != blockTail) {
                    ...
                    compiler_fence(Asynchronous::memory_order_release);
        ...
        private:
            ...
            bool inner_enqueue(U&& element)
            {
                ...
                if (nextBlockTail != blockFront) {
                    ...
                    fence(Asynchronous::memory_order_acquire);		// Ensure we get latest writes if we got the latest frontBlock
        ...
        private:
            ...
            struct Block
            {
                ...
                Asynchronous::weak_atomic<size_t> front;	// (Atomic) Elements are read from here
                
                AE_ALIGN(CACHE_LINE_SIZE)
                Asynchronous::weak_atomic<size_t> tail;	// (Atomic) Elements are enqueued here
                
                AE_ALIGN(CACHE_LINE_SIZE)	// next isn't very contended, but we don't want it on the same cache line as tail (which is)
                Asynchronous::weak_atomic<Block*> next;	// (Atomic)
        ...
        private:
            Asynchronous::weak_atomic<Block*> frontBlock;		// (Atomic) Elements are enqueued to this block
            
            char cachelineFiller[CACHE_LINE_SIZE - sizeof(Asynchronous::weak_atomic<Block*>)];
            Asynchronous::weak_atomic<Block*> tailBlock;		// (Atomic) Elements are dequeued from this block
