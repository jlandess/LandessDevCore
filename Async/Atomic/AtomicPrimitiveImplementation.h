//
//  AtomicPrimitiveImplementation.h
//  DataStructures
//
...
#ifndef DataStructures_AtomicPrimitiveImplementation_h
#define DataStructures_AtomicPrimitiveImplementation_h
...
#define TURF_C_IMPL_ATOMIC_PATH "atomic_msvc.h"
#elif TURF_COMPILER_GCC && (TURF_CPU_X86 || TURF_CPU_X64)
#define TURF_C_IMPL_ATOMIC_PATH "atomic_gcc_x86-64.h"
#elif TURF_COMPILER_GCC && TURF_CPU_ARM
#define TURF_C_IMPL_ATOMIC_PATH "atomic_gcc_arm.h"
#else
