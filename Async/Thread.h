...
#define  CUT_THREADEND return 0
    ...
    public:
        ...
        inline PDP::Commitment<T> EnqueueWithCommitment(const Object & object, T (Object::*MemberPointer)(PDP::Commitment<U>,Args...) const , const PDP::Decay_T<Args> & ... arguements);
         ...
         */
        template<typename T, typename U, typename Object, typename ... Args>
        inline PDP::Commitment<T> EnqueueWithCommitment( Object & object, T (Object::*MemberPointer)(PDP::Commitment<U>,Args...)  , const PDP::Decay_T<Args> & ... arguements);
        ...
        inline LD::Pair<PDP::Promise<T>,PDP::Commitment<U>> EnqueueWithPromiseAndCommitment(const  Functor<T(PDP::Commitment<U>, Args...)> & delegate, const PDP::Decay_T<Args> & ... arguements);
         ...
         */
        template<typename T, typename U, typename Object, typename ... Args>
        inline LD::Pair<PDP::Promise<T>,PDP::Commitment<U>> EnqueueWithPromiseAndCommitment(const Object & object, T (Object::*MemberPointer)(PDP::Commitment<U>,Args...) const , const PDP::Decay_T<Args> & ... arguements);
         ...
         */
        template<typename T, typename U, typename Object, typename ... Args>
        inline LD::Pair<PDP::Promise<T>,PDP::Commitment<U>> EnqueueWithPromiseAndCommitment( Object & object, T (Object::*MemberPointer)(PDP::Commitment<U>,Args...)  , const PDP::Decay_T<Args> & ... arguements);
