...
#include <Algorithms/fsm.h>

#include "MVC/TermBoxConsoleApplication.h"
#include "Definitions/TimeExtension.h"
#include "SchedulingQuittingPredicate.h"
namespace LD
{
...
namespace LD
{
    ...
    {
        using ContextTypeList = LD::TypeList<LD::Decay_T<A>...>;
