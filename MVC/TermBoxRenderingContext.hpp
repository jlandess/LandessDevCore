...
namespace LD
{
    ...
    public:
        ...
        >,const LD::TermBoxRenderContext&> RenderObject(T && object, const PDP::Detail::tVec2<LD::Integer> & translation) noexcept (noexcept(LD::Declval<LD::Decay_T<T>>()(LD::Declval<const LD::TermBoxRenderContext&>(),LD::Declval<PDP::Detail::tVec2<LD::Integer>>())))
        {
