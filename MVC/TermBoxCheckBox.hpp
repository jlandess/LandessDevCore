...
#ifndef LANDESSDEVCORE_TERMBOXCHECKBOX_HPP
#define LANDESSDEVCORE_TERMBOXCHECKBOX_HPP
...
namespace LD
{
    namespace TUI
    {
        ...
        private:
            //9,673
            wchar_t mBoxState[2] = {9634,9673};
            LD::BasicVec2D<LD::Integer> mPosition;
            wchar_t mSelectionKey;
            bool mState;
        public:
            constexpr RadioButton(const LD::BasicVec2D<LD::Integer> & loc = {0,0},const bool & state = false) noexcept:mState{state},mPosition{loc},mSelectionKey{' '}
            {
...
#endif //LANDESSDEVCORE_TERMBOXCHECKBOX_HPP
