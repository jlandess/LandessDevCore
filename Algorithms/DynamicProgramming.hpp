...
#ifndef LANDESSDEVCORE_DYNAMICPROGRAMMING_HPP
#define LANDESSDEVCORE_DYNAMICPROGRAMMING_HPP
/*****************************************/
...
class CMap {
private:
    Foundation::Matrix<bool> m_walls;	//	true if wall
    CAction m_actionProbs;
    Foundation::Matrix<float> m_costs;
...
private:
    ...
    Foundation::Matrix<char> m_bestAction;
    //	The goal.
 ...
 */
#endif //LANDESSDEVCORE_DYNAMICPROGRAMMING_HPP
