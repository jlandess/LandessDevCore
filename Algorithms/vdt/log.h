...
// Log double precision --------------------------------------------------------
    inline double fast_log(double x)
    {
        ...
        res = ((original_x > details::LOG_UPPER_LIMIT)*(std::numeric_limits<double>::infinity())) + (!(original_x > details::LOG_UPPER_LIMIT)*res);
        res = ((original_x < details::LOG_LOWER_LIMIT)*(- std::numeric_limits<double>::quiet_NaN())) + (!(original_x < details::LOG_LOWER_LIMIT)*res);
        //res += ((original_x > details::LOG_UPPER_LIMIT)*(std::numeric_limits<double>::infinity()));
        ...
        //res += ((original_x < details::LOG_LOWER_LIMIT)*(- std::numeric_limits<double>::quiet_NaN()));
