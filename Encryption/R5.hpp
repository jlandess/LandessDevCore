...
#ifndef LANDESSDEVCORE_R5_HPP
#define LANDESSDEVCORE_R5_HPP
#include "Crypt.hpp"
inline int rc5_setup(unsigned char *key, int keylen, int num_rounds, union symmetric_key *skey)
{
...
inline void rc5_ecb_encrypt(unsigned char *pt, unsigned char *ct, union symmetric_key *key)
{
    unsigned long A, B;
    int r;
...
inline void rc5_ecb_decrypt(unsigned char *ct, unsigned char *pt, union symmetric_key *key)
{
    unsigned long A, B;
    int r;
