...
#ifndef LANDESSDEVCORE_R6_HPP
#define LANDESSDEVCORE_R6_HPP
#include "Crypt.hpp"
inline int rc6_setup(unsigned char *key, int keylen, int num_rounds, union symmetric_key *skey)
{
...
inline void rc6_ecb_encrypt(unsigned char *pt, unsigned char *ct, union symmetric_key *key)
{
...
inline void rc6_ecb_decrypt(unsigned char *ct, unsigned char *pt, union symmetric_key *key)
{
    unsigned long a,b,c,d,t,u;
    int r;
